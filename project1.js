...
if (notHakeem != "Hakeem Olajuwon") {
  ...
  console.log("Hakeem Olajuwon");
} else {
  console.log('Karl Malone');
}
...
//If the param value is 'green' set colorResponse variable to 'Green is okay'. If the param value is 'red' set reponse variable to 'I heart red'.
// Otherwise set the colorResponse variable to 'What is your favorite color?'. Make sure to return the colorResponse variable at the end once it has been properly set.
...
// #10 Create a function called greeter that takes in two parameters, name(a string) and number(a number). 
//Have greeter return a string that says something like this 'Hi! I am Bryan and I am 28 years old" but with the appropriate values.

// CODE HERE
function greeter(name, number) {
  let greeting = "Hi! I am " + name + " and I am " + number + " years old";
  return greeting;
}
greeter("Emma",24);